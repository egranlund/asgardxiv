		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info">
				<div class="container_16">
					...
					<!-- Design By -->
					<div class="grid_8">
						<p style="display:none" class="designby"><?php _e('Designed by', 'wplook'); ?> <a href="http://themeforest.net/item/charitas-foundation-wordpress-theme/5150694<?php if ( ot_get_option('wpl_affiliate') ) { ?>?ref=<?php echo ot_get_option('wpl_affiliate'); } else {echo "?ref=wplook";} ?>" title="<?php _e('WPlook', 'wplook'); ?>" target="_blank">WPlook</a></p>
					</div>
